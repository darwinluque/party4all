...
module.exports = {
    ...
    var mailOptions = {
        from: 'info-party4all@party4all.com', // sender address
        //to: 'darwin.luque@gmail.com', // list of receivers
        to: req.body.str_email.toLowerCase(), // list of receivers
    ...
    transporter.sendMail(mailOptions, function(error, info){
        if(error){
            res.json({
                code: '5',
                error: 'ERROR: No se puedo enviar el correo, se presentó el siguiente error: '+error
            });
        }else{
            res.json({
                code: '0',
...
>>>>>>> b107886764454b5623216581931cb4ef8d64af2e
