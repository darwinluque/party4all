//var nodemailer = require('mailgun-js');
...
exports.enviarMail = function(str_primer_nombre, str_segundo_nombre, str_primer_apellido, str_segundo_apellido, str_email, str_password) {
    ...
    var api_key = 'd5977f06ae28619c0f1b9a444ab06e59-c9270c97-c83e9e54';
    var domain = 'sandbox081c92addfeb4f4eb0a51048b4c2997b.mailgun.org';
    var mailgun = require('mailgun-js')({apiKey: api_key, domain: domain});
    
    var data = {
        from: 'info-party4all@party4all.co',
        to: str_email.toLowerCase(),
        subject: 'Te damos la bienvenida a Party4All',
        html: text
    };
    ...
    mailgun.messages().send(data, function (error, body) {
        if(error){
            ...
            return 'El correo fue enviado con exito - '+body.response;
        };
    });
    /*
